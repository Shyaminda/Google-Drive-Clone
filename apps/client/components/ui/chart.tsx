...
import { calculatePercentage, convertFileSize } from "@/utils/utils";
...
export const Chart = ({ used = 0, max = 0 }: { used: number; max: number }) => {
	const chartData = [{ storage: used, max, fill: "white" }];
